...
const projects = [
  {
    title: "CloudSync Pro",
    description: "Real-time file synchronization platform with end-to-end encryption. Built for enterprise teams managing sensitive documents across distributed systems.",
    ...
    technologies: ["React", "Node.js", "AWS S3", "WebSocket"],
    liveUrl: "#",
    githubUrl: "#",
  },
  {
    title: "Analytics Dashboard",
    description: "High-performance analytics dashboard processing millions of events in real-time. Features custom visualization engine and ML-powered insights.",
  ...
  {
    title: "DevFlow CLI",
    description: "Open-source CLI tool for automating development workflows. Supports custom plugins and integrates with popular CI/CD platforms.",
